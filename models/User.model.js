...
const userSchema = new Schema(
  {
    ...
    wand: [{
      wood: String,
      enum: ["Acacia", "Alder", "Apple", "Ash", "Aspen", "Beech", "Blackthorn", "Black Walnut", "Cedar", "Cherry", "Chestnut", "Cypress", "Dogwood", "Ebony", "Elder", "Elm", "English Oak", "Fir", "Hawthorn", "Hazel"], // BONUS: SECCIO ESPECIAL
      core: String,
      enum: ["Unicorn Hair", "Dragon Heartstrings", "Phoenix Feather", "Basilisk Horn", "Thestral Tail Hair", "Thunderbird Tail Feather", "White River Monster Spine", "Horned Serpent Horn"], // BONUS: SECCIO ESPECIAL
    }],
